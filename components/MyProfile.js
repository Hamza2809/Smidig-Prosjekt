    ...
    <div className="max-w-sm h-auto mx-auto my-20 rounded-md overflow-hidden shadow-lg">
      ...
      <div className="px-6 py-4">
        <div className="flex flex-col">
          <div className="font-bold text-xl text-center text-gray-800 hover:text-pink-500 hover:cursor-pointer">Petter Petter
          </div>
          <p className="text-gray-600 text-sm text-center">Frontend og Mobilutvikling</p>
        </div>
        <div className="flex flex-row justify-center font-semibold mx-auto my-4">
          <div
              className="my-auto text-white bg-pink-500 hover:bg-pink-600 hover:cursor-pointer rounded-3xl py-2 px-4 mx-2">Follow
          </div>
          <div
              className="my-auto text-gray-800 py-1 px-4 border-2 border-pink-500 hover:bg-pink-500 hover:cursor-pointer hover:text-white rounded-3xl mx-2">Message
          </div>
        </div>
      </div>

      <div className="flex flex-row justify-center">
        <img className="object-cover hover:cursor-pointer rounded-full h-12 w-12 m-3 p-0.5 border-2 border-pink-600"
             src="https://images.pexels.com/photos/2709388/pexels-photo-2709388.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
             alt="Human Picture by Ike louie Natividad"/>
        <img className="object-cover hover:cursor-pointer rounded-full h-12 w-12 m-3 p-0.5 border-2 border-pink-600"
      ...
      <div>
        <h4 className="text-sm text-center my-2 font-semibold text-gray-700">About me</h4>
        <p className="text-xs mx-6 text-justify">I specialize in designing and developing user interfaces and digital
          products. I don’t restrict myself to design.</p>
      </div>
